...
public class LoginTest {
	...
	@When("have to enter below set of {string} and {string}")
	public void have_to_enter_below_set_of_and(String string, String string2) {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new io.cucumber.java.PendingException();
		obj.link_sigin();
		obj.name_username(string);
		obj.name_password(string2);
